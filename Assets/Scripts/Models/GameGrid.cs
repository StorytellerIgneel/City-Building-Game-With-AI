...
public class GameGrid
{
    ...
    public static bool IsCellWakable(PointType PointType, bool aiAgent = false)
    {
        if (aiAgent)
        {
            return PointType == PointType.Road;
        }
        return PointType == PointType.Empty || PointType == PointType.Road;
    }
    ...
    public override string ToString()
    {
        ...
        for (int y = _height - 1; y >= 0; y--) // top row first (more intuitive)
        {
